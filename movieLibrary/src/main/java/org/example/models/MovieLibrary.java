...
public class MovieLibrary {
    ...
    public void fillMovieList() {
        ...
        Actor russelCrow = new Actor("Russel", "Scott");
        ...
        movies.add(new Movie ("Gladiator", ridleyScott, List.of(russelCrow, o_Reed, d_Jacob) ) ); //nowy obiekt i od razu dodany do listy
    ...
    private List<String> getActorFilmographyList(Actor actorToFind) {
        Predicate<Movie> movieCheck = movie -> movie.getActors().stream() // Predicate konstrukcja, która służy do sformułowania warunku
